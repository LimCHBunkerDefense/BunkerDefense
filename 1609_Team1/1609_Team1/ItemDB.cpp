...
void ItemDB::Init()
{
	...
	// 상점 구매 아이템(소모품)
	Add(new ItemData(ITEM_USINGITEM, 1005, 100, 0, 0,   0, 0, 50,   TEXT("수류탄")));
	Add(new ItemData(ITEM_USINGITEM, 1006, 200, 0, 0,   0, 0, 3000, TEXT("공중 폭격")));
	Add(new ItemData(ITEM_USINGITEM, 1007,  30, 0, 0,   0, 0, 1000, TEXT("용암지대")));
	Add(new ItemData(ITEM_USINGITEM, 1008,   0, 0, 100, 0, 0, 200,  TEXT("벙커 수리")));
	...
	Add(new ItemData(ITEM_BULLET, 1012, 0, 0, 0, 0, 100, 150, TEXT("레이저 건 충전")));
}
