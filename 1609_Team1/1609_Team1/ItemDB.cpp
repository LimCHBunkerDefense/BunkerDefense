...
void ItemDB::Init()
{
	...
	Add(new ItemData(ITEMTYPE_WEAPON, ITEM_MACHINEGUN, 1003, 30,100.0f, 0, 35.0f, 0, 2000, 500, 1, 2000, TEXT("기관총(Machine Gun)"),
		TEXT("연사가 가능한 기관총. \n시원한 타격감이 일품인 총이다."), TEXT("중")));
	Add(new ItemData(ITEMTYPE_WEAPON, ITEM_LASERGUN, 1004, 50, 120.0f, 0, 15.0f, 0, 2000, 1000, 1, 5000, TEXT("레이저 건(Laser Gun)"),
