...
{
	// 기본 무기
	Add(new ItemData(ITEMTYPE_WEAPON, ITEM_PISTOL, 1001, 30, 60.0f, 0, 20.0f, 0, 60, 10,   1, 0,   TEXT("권총(Pistol)"),
		TEXT("기본 총이다. \n상점에서 구매할 수 없다."), TEXT("하")));
	
	// 상점 구매 무기
	Add(new ItemData(ITEMTYPE_WEAPON, ITEM_SHOTGUN, 1002, 120, 50.0f, 0, 25.0f, 0, 24, 2, 1, 1200, TEXT("샷건(Shot Gun)"),
		TEXT("근거리에서 사용가능한 샷건. \n근거리에서 엄청난 화력을 자랑한다."), TEXT("하")));
	Add(new ItemData(ITEMTYPE_WEAPON, ITEM_MACHINEGUN, 1003, 80, 100.0f, 0, 35.0f, 0, 2000, 500, 1, 2000, TEXT("기관총(Machine Gun)"),
		TEXT("연사가 가능한 기관총. \n시원한 타격감이 일품인 총이다."), TEXT("중")));
	Add(new ItemData(ITEMTYPE_WEAPON, ITEM_LASERGUN, 1004, 200, 120.0f, 0, 15.0f, 0, 2000, 1000, 1, 5000, TEXT("레이저 건(Laser Gun)"),
