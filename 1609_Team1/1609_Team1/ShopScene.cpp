...
ShopScene::ShopScene()
{
	...
	OBJECT->CreateItem(ITEM_PISTOL, 1001);
	OBJECT->CreateItem(ITEM_MACHINEGUN,1002);
	OBJECT->CreateItem(ITEM_FIRETHROWER,1003);
	OBJECT->CreateItem(ITEM_LASERGUN,1004);
	OBJECT->CreateItem(ITEM_PSBULLET,1005);
	OBJECT->CreateItem(ITEM_MGBULLET,1006);
	OBJECT->CreateItem(ITEM_FTBULLET,1007);
	OBJECT->CreateItem(ITEM_LGBULLET,1008);
	OBJECT->CreateItem(ITEM_GRENADE,1009);
	OBJECT->CreateItem(ITEM_AIRBOMB,1010);
	OBJECT->CreateItem(ITEM_RAVAREGION,1011);
	OBJECT->CreateItem(ITEM_BUNKERREPAIR,1012);
