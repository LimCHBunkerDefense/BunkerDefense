...
enum BUTTON_TAG
{
	BUTTON_NONE, BUTTON_BUY, BUTTON_SELL, BUTTON_WEAPON, BUTTON_BULLET, BUTTON_USINGITEM,
};

enum BOX_TAG
{
	BOX_NONE, BOX_WEAPON, BOX_BULLET, BOX_USINGITEM,
	BOX_PISTOL, BOX_MACHINEGUN, BOX_FIRETHROWER, BOX_LASERGUN,
	BOX_PSBULLET, BOX_MGBULLET, BOX_FTBULLET, BOX_LGBULLET,
	BOX_GRENADE, BOX_AIRBOMB, BOX_RAVAREGION, BOX_BUNKERREPAIR,
};
