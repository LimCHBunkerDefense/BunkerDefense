...
enum OBJ_TAG
{
	OBJ_NONE, OBJ_PLAYER, OBJ_ENT, OBJ_BUNKER, OBJ_BULLET,
};
...
{
	GUN_NONE,
	PISTOL_IDLE, PISTOL_ATTACK,
	MACHINEGUN_IDLE, MACHINEGUN_ATTACK,
	FIRETHROWER_IDLE, FIRETHROWER_ATTACK,
	LASERGUN_IDLE, LASERGUN_ATTACK,
};
...
enum CREATURE_STATE
{
	CREATURE_NONE, CREATURE_IDLE, CREATURE_RUN, CREATURE_ATTACK, CREATURE_DEAD, BULLET_IDLE, BULLET_EXPLODE,
};
